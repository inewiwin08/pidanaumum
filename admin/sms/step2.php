...
// jumlah maksimum modem sek bisa diset
$maxmodem = 8;
...
<table>
 ...
 <tr valign="top"><td>CONNECTION</td><td>:</td><td><select name="connection"><option>at115200</option><option>at19200</option><option>at9600</option><option>at</option></select><br><small>Pilih jenis connection hp/modem Anda.</small></td></tr>
...
echo "</table>";
echo "<p><b>Perhatian!</b><br>Pastikan sebelum menghapus modem, service Gammu untuk modem tersebut harus dimatikan dahulu</p>";
echo "</td>";
echo "<td width='2%'>&nbsp;";
